...
1 RESULT pass system.mode system_mode_restart PREVIEW 10/10 Sequence complete
1 RESULT fail pointset pointset_publish STABLE 0/10 Message exception: Could not upgrade message: While parsing version string 1.4.
1 CPBLTY fail system broken_config.logging ALPHA 0/1 Failed waiting until (logging) system logs level `DEBUG` category `system.config.receive`: no logs
...
0 RESULT pass system broken_config STABLE 9/10 Sequence complete
1 CPBLTY fail system broken_config.logging ALPHA 0/1 Failed waiting until (logging) system logs level `DEBUG` category `system.config.receive`: no logs
0 CPBLTY fail system broken_config.status ALPHA 0/1 Failed check that (status) category matches `system.config.parse`
0 RESULT pass system broken_config STABLE 8/10 Sequence complete
1 CPBLTY fail system broken_config.logging ALPHA 0/1 Failed waiting until (logging) system logs level `NOTICE` category `system.config.apply`: no logs
0 CPBLTY fail system broken_config.status ALPHA 0/1 Failed waiting until (status) system status level is >= `WARNING` (400): no significant device system status
0 RESULT pass system broken_config STABLE 8/10 Sequence complete
...
1 RESULT fail gateway gateway_proxy_events BETA 0/10 Failed waiting until All proxy devices received pointset: Missing pointset from AHU-22
1 RESULT pass gateway gateway_proxy_state PREVIEW 10/10 Sequence complete
1 RESULT fail gateway gateway_proxy_state PREVIEW 0/10 Failed waiting until All proxy devices received update: Missing update from AHU-22
1 RESULT pass discovery.scan scan_single_future+bacnet PREVIEW 10/10 Sequence complete
0 RESULT pass discovery.scan scan_single_future+vendor PREVIEW 10/10 Sequence complete
1 RESULT pass discovery.scan scan_periodic_now_enumerate+bacnet PREVIEW 10/10 Sequence complete
0 RESULT pass discovery.scan scan_periodic_now_enumerate+vendor PREVIEW 10/10 Sequence complete
4 RESULT pass gateway gateway_proxy_events BETA 10/10 Sequence complete
1 RESULT pass gateway gateway_proxy_events BETA 10/10 Sequence complete
1 RESULT fail gateway gateway_proxy_state PREVIEW 0/10 Failed waiting until All proxy devices received update: Missing update from SNS-4, AHU-22
