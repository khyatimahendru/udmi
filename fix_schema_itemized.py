...
1 pointset_remove_point
1 too_much_state
1 enumerate_features
1 valid_serial_no RESULT pass schemas device_state_stable STABLE 10/10 Schema validation passed
0 valid_serial_no RESULT pass schemas events_system_stable STABLE 10/10 Schema validation passed
0 valid_serial_no RESULT pass schemas state_update_stable STABLE 10/10 Schema validation passed
1 valid_serial_no RESULT pass schemas device_state_stable STABLE 10/10 Schema validation passed
0 valid_serial_no RESULT pass schemas state_update_stable STABLE 10/10 Schema validation passed
1 valid_serial_no RESULT pass schemas device_state_stable STABLE 10/10 Schema validation passed
0 valid_serial_no RESULT pass schemas events_system_stable STABLE 10/10 Schema validation passed
...
0 broken_config RESULT pass schemas events_system_stable STABLE 10/10 Schema validation passed
0 broken_config RESULT pass schemas state_update_stable STABLE 10/10 Schema validation passed
1 broken_config RESULT fail schemas events_system_stable STABLE 10/10 Schema violations found
1 broken_config RESULT fail schemas state_update_stable STABLE 10/10 Schema violations found
1 broken_config RESULT pass schemas device_state_stable STABLE 10/10 Schema validation passed
1 broken_config RESULT pass schemas device_state_stable STABLE 10/10 Schema validation passed
0 broken_config RESULT pass schemas events_system_stable STABLE 10/10 Schema validation passed
0 broken_config RESULT pass schemas state_update_stable STABLE 10/10 Schema validation passed
1 broken_config RESULT pass schemas events_system_stable STABLE 10/10 Schema validation passed
0 broken_config RESULT pass schemas state_update_stable STABLE 10/10 Schema validation passed
1 broken_config RESULT pass schemas device_state_stable STABLE 10/10 Schema validation passed
0 broken_config RESULT pass schemas events_system_stable STABLE 10/10 Schema validation passed
0 broken_config RESULT pass schemas state_update_stable STABLE 10/10 Schema validation passed
1 broken_config RESULT fail schemas events_system_stable STABLE 10/10 Schema violations found
0 broken_config RESULT fail schemas state_update_stable STABLE 10/10 Schema violations found
0 broken_config RESULT pass schemas device_state_stable STABLE 10/10 Schema validation passed
...
0 system_last_update RESULT fail schemas state_update_stable STABLE 10/10 Schema violations found
0 system_last_update RESULT pass schemas device_state_stable STABLE 10/10 Schema validation passed
1 state_make_model
4 valid_serial_no
1 system_last_update RESULT fail schemas events_system_stable STABLE 10/10 Schema violations found
...
1 gateway_proxy_events
1 gateway_proxy_state
1 gateway_proxy_state
1 scan_single_future
1 scan_periodic_now_enumerate
4 gateway_proxy_events
1 gateway_proxy_events
1 gateway_proxy_state
4 device_config_acked
1 bad_target_family
